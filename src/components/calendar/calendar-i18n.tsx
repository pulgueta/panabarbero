...
const DEFAULT_LABELS: CalendarI18nConfig["labels"] = {
  today: "Today",
  previous: "Previous",
  next: "Next",
  addEvent: "Add event",
...
const DEFAULT_VIEW_NAMES: CalendarI18nConfig["viewNames"] = {
  month: "Month",
  week: "Week",
  day: "Day",
...
const DEFAULT_FORMATS: CalendarI18nConfig["formats"] = {
...
function makeDefaultFunctions(
  cfg: Pick<CalendarI18nConfig, "labels" | "formats">,
): CalendarI18nConfig["functions"] {
  return {
...
const DEFAULT_CALENDAR_I18N: CalendarI18nConfig = {
...
type CalendarI18nOverrides = {
  [K in keyof CalendarI18nConfig]?: Partial<CalendarI18nConfig[K]>;
};
 ...
 * overrides still win.
 */
function mergeCalendarI18n(
  overrides?: CalendarI18nOverrides,
): CalendarI18nConfig {
  if (!overrides) return DEFAULT_CALENDAR_I18N;
...
export type { CalendarI18nConfig, CalendarI18nOverrides };
export { DEFAULT_CALENDAR_I18N, mergeCalendarI18n };
