...
export const PromptInput = ({
  ...
  const addFilesFromInput: ChangeEventHandler<HTMLInputElement> = useCallback(
    (event) => {
...
export const PromptInputSubmit = ({
  ...
  const submitClick = useCallback(
    (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      // biome-ignore lint/suspicious/noExplicitAny: forwarding event to base-ui handler
      onClick?.(e as any);
    },
  ...
  return (
    <InputGroupButton
      ...
      onClick={
        submitClick as ComponentProps<typeof InputGroupButton>["onClick"]
      }
      size={size}
