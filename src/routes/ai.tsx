...
function AiRoute() {
  return (
    <BorderContainer>
      <main>
        <section className="grid grid-cols-1 items-center gap-8 py-6 lg:grid-cols-[1.05fr_1fr] lg:gap-12 lg:py-10">
          <section className="space-y-6">
            ...
            <p className="max-w-md text-pretty text-muted-foreground">
              Pana vive dentro de tu dashboard y conoce tu agenda, tu equipo y
              tus servicios. Pregúntale en español y te responde con tus datos
              reales, no con genéricos.
            </p>
