...
export interface AppointmentCancelledByBarbershopEmailProps {
  barbershopName: string;
  notes: string;
  subject: string;
}

export const AppointmentCancelledByBarbershopEmail = ({
  barbershopName = "Barbería",
  notes = "Sin motivo alguno. Esto es un mensaje de prueba para ver como se ve el texto en el email.",
  subject = "Cita cancelada",
}: AppointmentCancelledByBarbershopEmailProps) => {
  return (
        ...
        <Body className="bg-gray-100 font-sans">
          <Container className="mx-auto w-full max-w-md rounded-xl border border-border/50 bg-white px-8 py-2">
            ...
            <Text className="text-pretty">
              Tu cita en {barbershopName} ha sido cancelada. Tu barbero ha
              proporcionado el siguiente motivo:
            </Text>
...
export default AppointmentCancelledByBarbershopEmail;
