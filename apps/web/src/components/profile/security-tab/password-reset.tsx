...
import { requestPasswordReset, useSession } from "@panabarbero/convex/auth";
...
type PasswordResetForm = z.infer<typeof forgotPasswordSchema>;
          ...
          <form onSubmit={handleRequestReset}>
            <div className="flex flex-col gap-3">
              <p className="text-muted-foreground text-sm">
                ...
                <strong>{session?.user?.email}</strong> para que puedas crear
                una nueva contraseña.
              </p>
              <Button
                type="submit"
